    ...
    <main>
       <div class="row">
           <header class="spotlight center dark-color">
               ...
               <a class="button-primary center hover-effect" href="queens.zip" download>DOWNLOAD</a>
           </header>
       </div>
       <div class="row wrapper">
            <div class="six-column spotlight center">
               <h2 class="center">Learn About The Framework</h2>
                ...
                <a href="pages/gettingstarted.php" class="button-primary center">Read the Reference Guide</a>
            </div>
       </div>
    </main>
</body>
