<nav class="top-navigation wrapper">
        ...
        <!--menu by riyanto r from the Noun Project-->
        <svg width="30px" class="push-right mobile-only" onclick="openNav()" role="navigation" version="1.1"
             x="0px" y="0px" viewBox="0 0 81.3 43.3"
